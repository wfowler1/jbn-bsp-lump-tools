// MAP510Writer class
//
// Writes a Gearcraft .MAP file from a passed Lump00 object
...
public class MAP510Writer {
	...
	public MAP510Writer(Lump00 from, String to, boolean gearcraftDecs) {
		this.data=from;
		this.path=to;
	...
	public void write() throws java.io.IOException {
		...
		try {
			...
			System.out.println("ERROR: Could not save "+mapFile.getPath()+", ensure the file is not open in another program and the path "+path+" exists");
			throw e;
		}
	}
	...
	private String brushSideToString(MAPBrushSide in) {
		try {
			...
			System.out.println("Side with bad data! Not exported!");
			return null;
		}
	}
