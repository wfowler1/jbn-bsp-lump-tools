...
public class NFBSP {
	...
	// CONSTRUCTORS
	// Empty contructor
	// Use this if the data will be populated by the accessors and mutators below.
	public NFBSP() {
		;
	}
	...
	public void swapXZ() {
		...
		// Planes
		for(int i=0;i<myL1.getNumElements();i++) {
			double temp=myL1.getPlane(i).getC();
			myL1.getPlane(i).setC(myL1.getPlane(i).getA());
			myL1.getPlane(i).setA(temp);
		}
		// Vertices
		for(int i=0;i<myL4.getNumElements();i++) {
			double temp=myL4.getVertex(i).getZ();
	...
	public void optimizeBSP() {
		...
		System.out.println("\nOptimizing entities...");
		optimizeEntities(); // Every entitiy is unique and cannot be recycled. However, some
		...
		try {
			for(int i=0;i<numEnts;i++) {
				...
				if(myL0.getEntity(i).getAttribute("classname").equals("multi_manager")) {
					myL0.getEntity(i).deleteAttribute("angles"); // Especially after compile, multi_managers no longer need to be within a map.
				}
				if(myL0.getEntity(i).getAttribute("classname").equals("env_fade")) {
					myL0.getEntity(i).deleteAttribute("angles"); // Especially after compile, env_fades no longer need to be within a map.
				}
				if(myL0.getEntity(i).getAttribute("classname").equals("multisource")) {
					myL0.getEntity(i).deleteAttribute("angles"); // Especially after compile, multisources no longer need to be within a map.
				}
	...
	public void decompile(String path) {
		Decompiler decompiler=new Decompiler(this, true, false, true, true, false, 100);
		try {
			decompiler.decompileBSP42();
		} catch(java.io.IOException e) {
			;
		}
	}
	...
	public String getMapName() {
		...
		return filepath.substring(filepath.length()-i,filepath.length()-4);
	}
	...
	public void setLump00(byte[] in) {
		myL0=new Lump00(in);
	}
	
	public void setLump01(byte[] in) {
		myL1=new Lump01(in);
	}
	
	public void setLump02(byte[] in) {
		myL2=new Lump02(in);
	}
	
	public void setLump03(byte[] in) {
		myL3=new Lump03(in);
	}
	
	public void setLump04(byte[] in) {
		myL4=new Lump04(in);
	}
	
	public void setLump05(byte[] in) {
		myL5=new Lump05(in);
	}
	
	public void setLump06(byte[] in) {
		myL6=new Lump06(in);
	}
	
	public void setLump07(byte[] in, int length) {
		myL7=new Lump07(in, length);
	}
	
	public void setLump08(byte[] in) {
		myL8=new Lump08(in);
	}
	
	public void setLump09(byte[] in, int numWorldFaces) {
		myL9=new Lump09(in, numWorldFaces);
	}
	
	public void setLump10(byte[] in) {
		myL10=new Lump10(in);
	}
	
	public void setLump11(byte[] in, int numWorldLeaves) {
		myL11=new Lump11(in, numWorldLeaves);
	}
	
	public void setLump12(byte[] in) {
		myL12=new Lump12(in);
	}
	
	public void setLump13(byte[] in) {
		myL13=new Lump13(in);
	}
	
	public void setLump14(byte[] in) {
		myL14=new Lump14(in);
	}
	
	public void setLump15(byte[] in) {
		myL15=new Lump15(in);
	}
	
	public void setLump16(byte[] in) {
		myL16=new Lump16(in);
	}
	
	public void setLump17(byte[] in) {
		myL17=new Lump17(in);
	}
}
